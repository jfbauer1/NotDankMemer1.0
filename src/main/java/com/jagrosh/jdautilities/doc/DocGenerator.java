 ...
 * {@link java.lang.Class Class}es and/or {@link java.lang.reflect.Method}s to format and document the command's they
 * represent.
 *
 ...
 * command system that uses Class and/or Method based commands, and works in any JVM language that supports
 * annotations.
 *
...
public class DocGenerator {
     ...
     * {@link com.jagrosh.jdautilities.doc.DocGenerator#getDocFor(java.lang.reflect.Method)}, and {@link
     * com.jagrosh.jdautilities.doc.DocGenerator#getDocForMethods(java.lang.Class)} also cache the values retrieved from
     * the invocation as a way to reduce reflection overhead for repeated calls.
     *
     * @param cacheSize The of the cache size that contains previously generated CommandDoc to reduce reflection
    ...
    /**
     * Gets a blank DocGenerator with no conversions loaded and with the specified separator, and a cache with the
     * specified max-size.
     *
     * <p>A separator will be appended to the documentation
     * returned by {@link com.jagrosh.jdautilities.doc.DocGenerator#getDocFor(java.lang.Class)} inbetween annotation
     * conversions.
    ...
    /**
     * Reads CommandDoc from the provided {@link java.lang.Class Class} and returns the String formatted and from it.
     *
    ...
    /**
     * Reads CommandDoc from the provided {@link java.lang.reflect.Method Method} and returns the String formatted and
     * from it.
     *
    ...
    /**
     * Reads all {@link java.lang.reflect.Method Method}s from the provided {@link java.lang.Class Class} and returns a
     * List of CommandDoc of each.
     *
    ...
    /**
     * Registers a CommandDoc {@link java.lang.annotation.Annotation Annotation} to this DocGenerator.
     *
     ...
     * @param converterParams The parameters necessary to instantiate the proper DocConverter.
     *                        <br>DocConverters can have multiple constructors, although it's
     *                        discouraged.
     * @return This DocGenerator
     * @throws IllegalArgumentException The annotation class provided is not annotated with {@link
     *                                  com.jagrosh.jdautilities.doc.ConvertedBy @ConvertedBy}, or an exception is
     *                                  thrown while instantiating the value said ConvertedBy annotation.
    ...
    /**
     * Registers a CommandDoc {@link java.lang.annotation.Annotation Annotation} to this DocGenerator with the provided
     * DocConverter.
     *
    ...
    private String read(AnnotatedElement ae) {
        ...
        if (cache.contains(ae)) return cache.get(ae);
