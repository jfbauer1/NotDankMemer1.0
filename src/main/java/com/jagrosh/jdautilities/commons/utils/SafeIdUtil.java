 ...
 * net.dv8tion.jda.core.utils.MiscUtil#parseSnowflake(String) MiscUtil.parseSnowflake(String)}, a utility used in
...
public final class SafeIdUtil {
    ...
    /**
     * Safely convert the provided String ID to a {@code long} usable with {@link net.dv8tion.jda.core.utils.MiscUtil#parseSnowflake(String)
    ...
    /**
     * Checks if the provided String ID is usable with {@link net.dv8tion.jda.core.utils.MiscUtil#parseSnowflake(String)
     * MiscUtil.parseSnowflake(String)}.
     *
     * @param id The String ID to be converted
